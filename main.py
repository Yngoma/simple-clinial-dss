...
class Ui_Home(object):
    def setupUi(self, Home):
        ...
        self.progview = QtWidgets.QTextEdit(self.centralwidget)
        self.progview.setGeometry(QtCore.QRect(560, 150, 221, 181))
        self.progview.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.progview.setObjectName("progview")
        self.label.raise_()
        ...
        def viewTo():
            ...
            cur = con.cursor()
            cur.execute(
                "SELECT * FROM Diseases WHERE(:Disease, :Prime_Symptom, :2nd_Symptom, :Temparature, :Bp_mmHg, :HR, :rrr)",
                {
                    'Disease': disease,
                    'Prime_Symptom': prime_symp,
                    '2nd_Symptom': sec_symp,
        ...
        self.diagnosis.clicked.connect(addTo)
